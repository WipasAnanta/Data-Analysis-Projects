...
-- Total deaths by age group in 2000
SELECT 
...
-- Total deaths by age group in 2021
SELECT 
 SUM(deaths_age_90_99) as age_90_99,
 SUM(deaths_age_80_89) as age_80_89,
 SUM(deaths_age_70_79) as age_70_79,
...
-- Percentage of total deaths by age group in 2000 
WITH age_deaths as (
  SELECT
 SUM(deaths_age_90_99) as age_90_99,
 SUM(deaths_age_80_89) as age_80_89,
...
-- Percentage of total deaths by age group in 2021  
WITH age_deaths as (
  SELECT
 SUM(deaths_age_90_99) as age_90_99,
 SUM(deaths_age_80_89) as age_80_89,
...
-- Percentage of total death per population in 2000
WITH pop_deaths AS (
SELECT
  death.Year,
  death.Entity,
...
-- Percentage of total death per population in 2021
WITH pop_deaths AS (
SELECT
  death.Year,
  death.Entity,
